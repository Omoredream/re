module git.wkr.moe/web3/solana-helper
...
replace (
	github.com/gagliardetto/metaplex-go v0.2.1 => github.com/GoudanWoo/metaplex-go v0.0.0-20240830143833-0bdcad028d3e
	github.com/gagliardetto/solana-go v1.9.3 => github.com/goudanwoo/solana-go v0.0.0-20240322234900-a7453ace94fc
)
