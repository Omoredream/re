...
func (address ProgramAddress) FindProgramDerivedAddress(seeds [][]byte) (programAddress AccountAddress, err error) {
	var programAddressPublicKey solana.PublicKey
	programAddressPublicKey, _, err = solana.FindProgramAddress(seeds, address.PublicKey)
	if err != nil {
...
func (address AccountAddress) FindAssociatedTokenAccountAddress(tokenAddress TokenAddress) (tokenAccountAddress TokenAccountAddress, err error) {
	...
	tokenAccountAddressPublicKey, _, err = solana.FindAssociatedTokenAddress(address.PublicKey, tokenAddress.PublicKey)
	if err != nil {
