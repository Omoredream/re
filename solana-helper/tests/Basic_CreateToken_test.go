...
import (
	...
	Pinata "git.wkr.moe/web3/solana-helper/ipfs/pinata"
...
func testCreateToken(ctx g.Ctx) (err error) {
	...
	err = Instruction.CreateTokenMetadata{
		Creator:              mainWallet.Account.Address,
		Token:                tokenInfo.Address,
		MintAuthority:        mainWallet.Account.Address,
	...
	err = Instruction.SetTokenAuthority{
		Token:         tokenInfo.Address,
