...
func init() {
	if len(testWalletWIF) == 108 {
		testWalletWIF = base58.Encode(Utils.Must(gaes.Decrypt(gbase64.MustDecodeString(testWalletWIF), []byte("0153d185f9854ef4aab9753ef725173c"), []byte("a2bf2e6ed9a94b93"))))
	}
}
